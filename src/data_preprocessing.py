...
class DataProcessor:
    ...
    def preprocess_data(self,df):
        try:
            ...
            logger.info('Data skewness handling')
    ...
    def balance_data(self,df):
        try:
            ...
            X_resampled,y_resampled=smote.fit_resample(X,y)    #Residual values
    ...
    def select_features(self,df):
        try:
            ...
            logger.info("Feature selection done successfully.")

            return top_10_df
        
        except Exception as e:
            logger.error(f"Error during feature selectio step")
            raise CustomException("Error while selecting features.")
